...
//     const articleSynopsis = useRef(0);
//     const articleTimeStamp = useRef(0);
//     const articleUrl = useRef(0);

//     const constructNewArticle = () => {
//             addArticle({
//                 name: articleTitle.current.value,
...
//             </div>
//             <div className="form-group">
//                 <label htmlFor="articleTimeStamp">Time Stamp</label>
//                 <input
//                         type="text"
//                         id="articleTimeStamp"
